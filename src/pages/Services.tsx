  ...
  const services = [
    {
      ...
      icon: <Ship size={48} className="text-logistics-500 mb-4" />,
    ...
    {
      id: "air-freight",
      icon: <Plane size={48} className="text-logistics-500 mb-4" />,
      title: "Air Freight",
    ...
    {
      id: "warehousing",
      icon: <Warehouse size={48} className="text-logistics-500 mb-4" />,
    ...
    },
    {
      ...
      icon: <Globe size={48} className="text-logistics-500 mb-4" />,
    ...
    <Layout>
      ...
      <section className="bg-logistics-700 text-white py-16">
        <div className="container-custom text-center">
          ...
          <Link to="/contact" className="btn-primary bg-white text-logistics-600 hover:bg-gray-100">
            Contact Us Now
          </Link>
        </div>
      </section>
